...
if "%Action%"=="2" (
    ...
    !LM! -ExportAllMap16 !ROMFILE! %MAP16_BACKUP%\latest_AllMap16.map16
    pause
)
:: Export Palettes
if "%Action%"=="3" (
    ...
    !LM! -ExportSharedPalette !ROMFILE! %PAL_BACKUP%\latest_Shared.pal
    pause
)
...
if "%Action%"=="4" (
    ...
    copy !ROMFILE! %ROM_BACKUP%\latest_%ROMNAME%.smc
    pause
)
if "%Action%"=="0" (
